using System.Linq;
using Content.Server.Ganimed.Disease.Components;
using Content.Server.Ganimed.Disease.Server;
...
using Content.Shared.Ganimed.Disease.Events;
using Content.Shared.Ganimed.Disease.Swab;
...
namespace Content.Server.Ganimed.Disease;
