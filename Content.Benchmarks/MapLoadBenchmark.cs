...
public class MapLoadBenchmark
{
    ...
    public static readonly string[] MapsSource = { "Empty", "Box", "Bagel", "Dev", "CentComm", "Atlas", "AtlasGanimed", "Core", "TestTeg", "Saltern", "SalternGanimed", "Packed", "Omega", "Cluster", "Reach", "Origin", "Meta", "Marathon", "Europa", "MeteorArena", "Fland", "Barratry", "Oasis" };
