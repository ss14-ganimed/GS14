...
station-goal-science =
    ...
    3. Если это Экспериментальные технологии, должны быть произведены и введены в эксплуатацию манипуляторы гравитации.
    4. Если это Сервис, должны быть произведены и введены в эксплуатацию телепады для отдела снабжения и "Скороходы" для Службы Безопасности.
