...
ent-ClothingMaskGasExplorer = противогаз первопроходца
...
ent-ClothingMaskNeckGaiter = шейная повязка
    .desc = Стильная повязка, покрывающая вашу шею и подбородок. Помогает от ветров и для создания определённого образа.
