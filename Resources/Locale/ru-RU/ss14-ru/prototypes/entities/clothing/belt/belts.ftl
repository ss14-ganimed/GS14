...
ent-ClothingBeltChiefEngineer = чёрный пояс инструментов
    .desc = Пояс с высокотехнологичными инструментами. Сама концепция чёрного не менее технологична.
...
ent-ClothingBeltBandolier = бандольер
    .desc = Бандольер для хранения ружейных патронов. Будут ли они у вас? Какая разница, с ним вы выглядите куда круче.
...
ent-ClothingBeltSalvageWebbing = кожаная РПС
    .desc = Универсальный разгрузочный жилет из поношенной кожи. Подходит для любых видов работ и работников.
ent-ClothingBeltMilitaryWebbing = армейская РПС
    .desc = Ременно-поясная система тактических ремней, которую носят различные абордажные группы.
ent-ClothingBeltMilitaryWebbingMed = армейская РПС медика
    .desc = Ременно-поясная система тактических ремней, которую носят оперативники-медики.
