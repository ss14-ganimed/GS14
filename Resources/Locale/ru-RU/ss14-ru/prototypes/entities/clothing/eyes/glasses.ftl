...
ent-ClothingEyesGlasses = очки
    .desc = Пара неприглядных очков с линзами по рецепту. Заставляют вас выглядеть умнее, чем вы есть на самом деле.
...
ent-ClothingEyesGlassesSunglasses = солнцезащитные очки
    .desc = Крутые солнечные очки. И чьей только шуткой было принести такие в радиоактивную пустошь?
...
ent-ClothingEyesGlassesMercenary = очки наёмника
    .desc = Очки, созданные для ведения боя, удобно защищающие глаза от яркого солнца. Впрочем, их владельцу далеко не обязательно всегда лезть на передовую.
...
ent-ClothingEyesVisorNinja = тактический визор
    .desc = Боевой визор, защищающий зрение от ярких вспышек и облегчающих ведение боя.
ent-ClothingEyesGlassesJamjar = очки ботаника
