...
ent-ClothingBackpackSecurity = рюкзак охраны
    .desc = Рюкзак службы безопасности. Не всегда бывает востребован на поле боя, но приходит на помощь тогда, когда действительно нужен.
...
ent-ClothingBackpackGenetics = рюкзак исследователя
    .desc = Рюкзак, специально разработанный быть суперпрочным на случай непредвиденных угроз.
