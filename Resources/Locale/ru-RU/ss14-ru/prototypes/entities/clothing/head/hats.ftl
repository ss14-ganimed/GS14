ent-ClothingHeadHatBeaverHat = бобровая шапка
    .desc = Джентльмены?
ent-ClothingHeadHatBeret = красный берет
    .desc = Берет, красный не от крови. Скорее всего, принадлежит службе безопасности.
...
ent-ClothingHeadHatBeretEngineering = берет менеджера
    .desc = Берет со значком инженерной службы. В цветах научно-исследовательского отдела. Оксюморон, но, чем бы начальство ни тешилось.
ent-ClothingHeadHatBeretHoS = шефский берет
...
ent-ClothingHeadHatBeretMerc = берет егеря
    .desc = Оливковый берет, на значке изображен шакал на скале. Имеет глубокое культурное значение в узких кругах.
...
ent-ClothingHeadHatWarden = фуражка смотрителя
    .desc = Красный вариант фуражки офицера полиции. Эта фуражка подчеркивает, что вы - БЕЗОПАСНОСТЬ.
ent-ClothingHeadHatWardenOriginal = фуражка смотрителя
...
ent-ClothingHeadHatBeretCmo = берет медика
    .desc = Простой бирюзовый берет. Его вид успокаивает и внушает надежду, что вас обязательно вылечат.
...
ent-ClothingHeadHatBeretSecurity = берет службы безопасности
    .desc = Стильный красный берет с символикой службы безопасности. Введен в эксплуатацию совсем недавно и, по какой-то причине, больше популярен среди медиков, чем среди офицеров.
