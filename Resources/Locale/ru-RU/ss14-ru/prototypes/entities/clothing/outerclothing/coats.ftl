ent-ClothingOuterCoatBomber = куртка-бомбер
    .desc = Толстая, поношенная кожаная куртка-бомбер, сохраняющая свою практичность и удобство во всех ситуациях.
ent-ClothingOuterCoatDetective = тренч детектива
    .desc = Редизайн стандартного тренча детектива. Выбирайте внешний вид, не теряя в защите.
...
ent-ClothingOuterCoatHoSTrench = шефский тренч
...
ent-ClothingOuterCoatLabGene = лабораторный халат исследователя
    .desc = Халат, повидавший многое. Имеет отличительные голубые полосы на плечах.
...
ent-ClothingOuterCoatRobo = стильный лабораторный халат
    .desc = Больше похоже на эксцентричное пальто, чем на лабораторный халат. Помогает выдать пятна крови за неотъемлемый элемент эстетики.
...
ent-ClothingOuterCoatLabSeniorPhysician = лабораторный халат заведующего
    .desc = Халат, защищающий от небольших разливов химикатов. Имеет светло-голубые рукава и оранжевую отделку на талии.
ent-ClothingOuterCoatSpaceAsshole = плащ негодяя
	.desc = Кожаный плащ космического негодяя.