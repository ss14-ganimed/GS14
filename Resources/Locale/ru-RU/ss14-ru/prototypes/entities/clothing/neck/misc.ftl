...
ent-ClothingNeckChiefbadge = шефский значок
    .desc = Значок, свидетельствующий что владелец является "законным" представителем НаноТразен везде, где это только возможно. Чем он сейчас может вам помочь - без понятия.
