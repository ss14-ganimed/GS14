...
ent-ClothingHeadsetForesters = гарнитура лесника
    .desc = Гарнитура, используемая лесниками, созданная из синей изоленты и сумрачного гения.
ent-ClothingHeadsetSecurity = гарнитура силовика
    .desc = Её используют ваши элитные силы безопасности.
ent-ClothingHeadsetFacility = гарнитура исследователя
    .desc = Гарнитура, используемая сотрудниками научно-исследовательского комплекса, выполняющими различные непростые задачи.
