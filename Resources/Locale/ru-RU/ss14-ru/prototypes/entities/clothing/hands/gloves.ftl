...
ent-ClothingHandsGlovesNitrile = голубые нитриловые перчатки
    .desc = Высококачественные нитриловые перчатки. Дорогое медицинское средство индивидуальной защиты, обычно поставляемое вам работодателем.
...
ent-ClothingHandsGlovesRobohands = перчатки механика
    .desc = Простые на вид перчатки механика. Уж вы-то точно знаете им достойное применение.
...
ent-ClothingHandsTacticalMaidGloves = тактические перчатки силовика
    .desc = Очень удобные и востребованные перчатки для лучших из лучших в рядах службы безопасности.
ent-ClothingHandsMercGlovesCombat = перчатки наёмника
    .desc = Боевые перчатки для защиты рук во время боя. Проверены временем и боем.
