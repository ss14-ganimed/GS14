...
ent-ClothingHandsGlovesNitrileAlt = старые нитриловые перчатки
    .desc = Снятая с производства модель нитриловых перчаток. Всё ещё стоит на страже медицинской защиты.
