ent-IDCardStandard = ID карта
    .desc = Ваша собственная ID карта. В зависимости от ситуации, может быть почти полностью бесполезна.
...
ent-CivilianIDCard = ID карта
    .desc = { ent-PassengerIDCard.desc }
ent-TechnicianIDCard = ID карта ассистента
    .desc = { ent-PassengerIDCard.desc }
ent-EngineerIDCard = ID карта инженера
    .desc = { ent-PassengerIDCard.desc }
ent-ScientistIDCard = ID карта учёного
    .desc = { ent-PassengerIDCard.desc }
ent-ManagerIDCard = ID карта менеджера
    .desc = { ent-PassengerIDCard.desc }
ent-ChiefIDCard = ID карта шефа
    .desc = { ent-PassengerIDCard.desc }
ent-OfficerIDCard = ID карта офицера
    .desc = { ent-PassengerIDCard.desc }
ent-MedicIDCard = ID карта медика
    .desc = { ent-PassengerIDCard.desc }
ent-RangerIDCard = ID карта егеря
    .desc = { ent-PassengerIDCard.desc }
ent-HunterIDCard = ID карта охотника
    .desc = { ent-PassengerIDCard.desc }
