...
ent-EncryptionKeySecurity = ключ шифрования силовиков
    .desc = Ключ шифрования, используемый элитными силами службы безопасности.
ent-EncryptionKeyForesters = ключ шифрования лесников
    .desc = Ключ шифрования, собранный в полевых условиях для использования лесниками.
ent-EncryptionKeyFacility = ключ шифрования исследователей
    .desc = Ключ шифрования, используемый различными работниками исследователей.