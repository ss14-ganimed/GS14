...
ent-ClothingBeltBandolierImprovisedShellFilled = { ent-ClothingBeltBandolier }
    .suffix = { Импровизированные патроны, Заполненный }
    .desc = { ent-ClothingBeltBandolier.desc }
ent-ClothingBeltUtilityScarceFilled = { ent-ClothingBeltUtility }
    .suffix = { Полупустой, Заполненный }
    .desc = { ent-ClothingBeltUtility.desc }
